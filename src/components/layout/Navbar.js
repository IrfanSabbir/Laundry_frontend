...
const Navbar = () => {
  ...
  const authLinks = (
    <>
      ...
      <li className="pe-3 nav-item nav-link text-light px-3 fs-5">Hello</li>
      {/* <li className="pe-3 nav-item nav-link text-light px-3 fs-5">Hello {user && user.firstName}</li> */}
      <li className="text1 nav-item">
        <Link to="/login" onClick={onLogout} className="nav-link text-light px-3 fs-5">
